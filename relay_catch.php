<?php
	...
	$sction_index	= $_POST[1]['section_index'];
	$lap_number		= $_POST[1]['lap_number'];
	$driver_index	= $_POST[1]['driver_index'];
	$section_name	= $_POST[1]['section_name'];
	$start_v		= $_POST[1]['start_v'];
	$end_v			= $_POST[1]['end_v'];
	$in_section		= $_POST[1]['in_section'];
	$max_speed		= $_POST[1]['max_speed'];
	$max_speed_v	= $_POST[1]['max_speed_v'];
	$min_speed		= $_POST[1]['min_speed'];
	$min_speed_v	= $_POST[1]['min_speed_v'];
	$max_g			= $_POST[1]['max_g'];
	$max_g_v		= $_POST[1]['max_g_v'];
	$tyre_temp_fl_in	= $_POST[1]['tyre_temp_fl_in'];
	$tyre_temp_fr_in	= $_POST[1]['tyre_temp_fr_in'];
	$tyre_temp_rl_in	= $_POST[1]['tyre_temp_rl_in'];
	$tyre_temp_rr_in	= $_POST[1]['tyre_temp_rr_in'];
	$tyre_temp_fl_ce	= $_POST[1]['tyre_temp_fl_ce'];
	$tyre_temp_fr_ce	= $_POST[1]['tyre_temp_fr_ce'];
	$tyre_temp_rl_ce	= $_POST[1]['tyre_temp_rl_ce'];
	$tyre_temp_rr_ce	= $_POST[1]['tyre_temp_rr_ce'];
	$tyre_temp_fl_ot	= $_POST[1]['tyre_temp_fl_ot'];
	$tyre_temp_fr_ot	= $_POST[1]['tyre_temp_fr_ot'];
	$tyre_temp_rl_ot	= $_POST[1]['tyre_temp_rl_ot'];
	$tyre_temp_rr_ot	= $_POST[1]['tyre_temp_rr_ot'];
	$tyre_press_fl	= $_POST[1]['tyre_press_fl'];
	$tyre_press_fr	= $_POST[1]['tyre_press_fr'];
	$tyre_press_rl	= $_POST[1]['tyre_press_rl'];
	$tyre_press_rr	= $_POST[1]['tyre_press_rr'];
	$datetime		= $_POST[1]['datetime'];
